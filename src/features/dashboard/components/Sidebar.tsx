...
const sidebarItems: SidebarItem[] = [
    { label: "Home", iconPath: "/dashboard/home.svg", href: "#" },
    { label: "Locker", iconPath: "/dashboard/locker.svg", href: "#" },
    { label: "Documents", iconPath: "/dashboard/documents.svg", href: "#" },
    { label: "RAG Bot", iconPath: "/dashboard/bot.svg", href: "#" },
    { label: "Profile", iconPath: "/dashboard/profile.svg", href: "#" },
    { label: "Settings", iconPath: "/dashboard/settings.svg", href: "#" },
];
